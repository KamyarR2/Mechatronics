...
if __name__ == '__main__':
    ...
    rospy.init_node('turtlesim_move5')


    rospy.wait_for_service('spawn')
    spawner = rospy.ServiceProxy('spawn', Spawn)

    spawner(9, 4.4, 0.0, 'turtle5')
    rospy.wait_for_service('turtle5/set_pen')
    pen_setter = rospy.ServiceProxy('turtle5/set_pen', SetPen)
    pen_setter(255, 69, 0, 4, 0)

    move_turtle_linear('turtle5',[1,0,0],0.5,1)
    move_turtle_linear('turtle5',[1,0,0],1,-1)
    move_turtle_linear('turtle5',[1,0,0],0.455,1)
    move_turtle_linear('turtle5',[0,1,0],2,1)
    move_turtle_linear('turtle5',[1,0,0],0.5,1)
    move_turtle_linear('turtle5',[1,0,0],1,-1)
    move_turtle_linear('turtle5',[1,0,0],0.5,1)
    move_turtle_angular('turtle5',1,85,1)

    pen_setter(0, 0, 0, 4, 1)
    move_turtle_linear('turtle5',[1,0,0],0.8,1)
