...
if __name__ == '__main__':
    ...
    rospy.init_node('turtlesim_move1')
    rospy.wait_for_service('turtle1/set_pen')
    pen_setter = rospy.ServiceProxy('turtle1/set_pen', SetPen)
    pen_setter(0, 0, 0, 0, 1)
    rospy.wait_for_service('turtle1/teleport_absolute')
    teleporter = rospy.ServiceProxy('turtle1/teleport_absolute', TeleportAbsolute)


    teleporter(6, 4.4, 0.0)
    pen_setter(0, 0, 255, 4, 0)

    rospy.wait_for_service('spawn')
    spawner = rospy.ServiceProxy('spawn', Spawn)
    move_turtle_linear('turtle1',[1,0,0],0.5,1)
    move_turtle_linear('turtle1',[1,0,0],1,-1)
    move_turtle_linear('turtle1',[1,0,0],0.455,1)
    move_turtle_linear('turtle1',[0,1,0],2,1)
    move_turtle_linear('turtle1',[1,0,0],0.5,1)
    move_turtle_linear('turtle1',[1,0,0],1,-1)
    move_turtle_linear('turtle1',[1,0,0],0.5,1)
    move_turtle_angular('turtle1',1,85,1)

    pen_setter(0, 0, 0, 4, 1)
    move_turtle_linear('turtle1',[1,0,0],0.8,1)
