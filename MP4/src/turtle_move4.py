...
if __name__ == '__main__':
    ...
    rospy.init_node('turtlesim_move4')

    rospy.wait_for_service('spawn')
    spawner = rospy.ServiceProxy('spawn', Spawn)
    spawner(7.0, 4.4, 0.0, 'turtle4')
    rospy.wait_for_service('turtle4/set_pen')
    pen_setter = rospy.ServiceProxy('turtle4/set_pen', SetPen)
    pen_setter(0, 0,255, 4, 0)

    move_turtle_linear('turtle4',[1,0,0],0.5,1)
    move_turtle_linear('turtle4',[1,0,0],1,-1)
    move_turtle_linear('turtle4',[1,0,0],0.455,1)
    move_turtle_linear('turtle4',[0,1,0],2,1)
    move_turtle_linear('turtle4',[1,0,0],0.5,1)
    move_turtle_linear('turtle4',[1,0,0],1,-1)
    move_turtle_linear('turtle4',[1,0,0],0.5,1)

    move_turtle_angular('turtle4',1,85,1)

    pen_setter(0, 0, 0, 4, 1)
    move_turtle_linear('turtle4',[1,0,0],0.8,1)
