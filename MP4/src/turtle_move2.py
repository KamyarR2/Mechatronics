...
if __name__ == '__main__':
    ...
    rospy.init_node('turtlesim_move2')



    rospy.wait_for_service('spawn')
    spawner = rospy.ServiceProxy('spawn', Spawn)
    spawner(4.0, 4.4, 0.0, 'turtle2')
    rospy.wait_for_service('turtle2/set_pen')
    pen_setter = rospy.ServiceProxy('turtle2/set_pen', SetPen)
    pen_setter(0, 255, 0, 4, 0)
    move_turtle_angular('turtle2',1,83,1)
    move_turtle_linear('turtle2',[1,0,0],2.2,1)
    move_turtle_linear('turtle2',[1,0,0],2.2,-1)
    move_turtle_angular('turtle2',1,35,1)
    move_turtle_linear('turtle2',[1,0,0],2.2,1)

    pen_setter(0, 0, 0, 4, 1)
    move_turtle_linear('turtle2',[1,0,0],2.2,-1)
    teleporter = rospy.ServiceProxy('turtle2/teleport_relative', TeleportRelative)
    teleporter(0.0, -20.0 * math.pi / 180)
    move_turtle_linear('turtle2',[1,0,0],0.6,-1)
